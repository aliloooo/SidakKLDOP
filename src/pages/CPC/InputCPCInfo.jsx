...
const schema = yup.object().shape({
    ...
    alamat_cpc: yup.string().required('Alamat CPC wajib diisi'),
...
export default function InputCPCInfo() {
    const navigate = useNavigate()
    const { identity, setIdentity } = useCPCStore()
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Laporan Kunjungan CPC</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="card space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input {...register('nama_vendor')} className="form-input pl-10" placeholder="Nama Vendor" />
                            </div>
                    ...
                    <div>
                        <label className="form-label">Alamat CPC KL yang Dikunjungi</label>
                        <div className="relative">
                            <MapPin className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                            <input {...register('alamat_cpc')} className="form-input pl-10" placeholder="Alamat Lengkap CPC" />
                        </div>
                        {errors.alamat_cpc && <p className="text-xs text-red-500 mt-1">{errors.alamat_cpc.message}</p>}
                    </div>
