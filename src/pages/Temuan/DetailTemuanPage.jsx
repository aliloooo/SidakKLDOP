...
import { Building2, Calendar, User, ArrowLeft, AlertTriangle, Download } from 'lucide-react'
...
export default function DetailTemuanPage() {
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: `Laporan_Temuan_${id?.substring(0, 8)}`,
        onAfterPrint: () => {
    ...
    const handleDownloadPDF = () => {
        ...
        const opt = {
            margin: [10, 10],
            filename: `Laporan_Temuan_${data?.nama_kl || id?.substring(0, 8)}.pdf`,
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 relative animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
            ...
            <div ref={printRef} className={`print:p-0 print:bg-transparent space-y-6 relative ${isDownloading ? 'bg-white p-8' : ''}`}>
                {/* Digital Stamp for Print (Top Right) */}
                ...
                <div className={`${isDownloading ? 'block' : 'hidden print:block'} border-b-2 border-gray-900 pb-8 mb-8`}>
                    <div className="space-y-1">
                        <h2 className="text-2xl font-black text-gray-900 tracking-tighter uppercase">Laporan Temuan Kunjungan</h2>
